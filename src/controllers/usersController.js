...
const controller = {
    ...
    processEditProfileData: async function(req, res){
        ...
        if(errors.isEmpty()){
            ...
            res.render('users/editProfileData', {errors: errors.mapped(), oldData: req.body, userData: req.session.userLogged})
        }       
    },
    ...
    processEditProfilePassword: async function(req, res){
        ...
        if(errors.isEmpty()){
            ...
            res.render('users/editProfilePassword', {errors: errors.mapped(), oldData: req.body, userData: req.session.userLogged})
        }
    },
    editProfileDireccion: async function(req, res){
        ...
        if(user){
            return res.render('users/editProfileDireccion', {userData:user.dataValues.direccion.dataValues})
        } else {
            res.render('error404')
        }
    },
    processEditProfileDireccion: async function(req, res){
        ...
        if(errors.isEmpty()){
            ...
            if(user){
                res.render('users/editProfileDireccion', {errors: errors.mapped(), oldData: req.body, userData:user.dataValues.direccion.dataValues})
            }
        }
    }, 
    ...
    processDestroyUser: async function(req, res){
        ...
        if(errors.isEmpty()){
            ...
            let user = await db.Users.findByPk(req.params.id)
            if(user){
                res.render('users/destroyUser', {errors: errors.mapped(), oldData: req.body, userData:user})
            }
        }
    },
